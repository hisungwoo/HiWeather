...
public interface WeatherService {
    ...
    Call<Example> listRepos(@Path("serviceKey") String serviceKey,
    ...
    @GET("http://apis.data.go.kr/1360000/VilageFcstInfoService/getVilageFcst?serviceKey=E6PZth5Xxp14kb9K%2BcdqMVPdltgGfmjR5OY8gEi1ARAV7mibmfWj7lq54rPJx0wiWoNJ0jZHAyMMsto875iTPw%3D%3D&numOfRows=100&pageNo=1&dataType=JSON&base_date=20210530&base_time=0500&nx=58&ny=125")
